---
layout: page
title: "Phase 1 — Frame Prep & Bonding Surface"
nav_order: 2
---
...
- Use clamps and a thin strip of hardboard at 13¼" as a jig to achieve a squared frame.
- Measure corner-to-corner to verify square (~56½").

{% include figure.html image="/Images/1.1-Raw-frame.jpeg" caption="Raw steel frame squared with clamps and hardboard jig." %}

- Measure cross-bars and use welding magnets to hold them in place for welding.
...
Welding warps steel. Place the frame on a perfectly flat table. If it rocks, use a hammer to gently tap it flat before continuing.
...
It is important to test the fit of the frame in the bed to make any additional corrections needed before casting in resin.
