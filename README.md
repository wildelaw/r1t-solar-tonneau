...
- **[Phase 6 — Do It Three More Times](https://wildelaw.github.io/r1t-solar-tonneau/build/phase-6-more-panels)** — 🛠️ in progress — all four frames pre-welded in Phase 1; Panels 1–3 complete and test-fit in the truck bed (Panel 1 + 2 under load: 17.34 V at 4.06 A, ~70 W in non-peak sun; Panel 1 has 5/16 cells cracked from a trapped air bubble; Panel 3 bus bars on opposite holes + one small center-cracked cell); Panel 4 planned as battery/inverter mount with locked access panel, optionally ~8 cells covering ~50%; then wire all four together
