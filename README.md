...
The site covers the complete build process:

- **[Materials](https://wildelaw.github.io/r1t-solar-tonneau/materials)** — full bill of materials with resin volume math
- **[Phase 1 — Frame Prep & Bonding Surface](https://wildelaw.github.io/r1t-solar-tonneau/build/phase-1-frame-prep)** — weld, flatten, prime, test-fit
- **[Phase 2 — Bottom-Up Layup & Hole Drilling](https://wildelaw.github.io/r1t-solar-tonneau/build/phase-2-layup)** — fiberglass back skin, amine blush removal, drill wire exits
- **[Phase 3 — Cell Placement & Routing](https://wildelaw.github.io/r1t-solar-tonneau/build/phase-3-cells)** — Kapton insulation, cell stringing, bus-bar routing, clay seal
- **[Phase 4 — The Resin Pour](https://wildelaw.github.io/r1t-solar-tonneau/build/phase-4-resin)** — seal coat, flood coat, expansion gap, torch bubbles, cure
- **[Phase 5 — Post-Cure, Expansion Cap & J-Box Soldering](https://wildelaw.github.io/r1t-solar-tonneau/build/phase-5-post-cure)** — demold, clay removal, silicone cap, J-Box solder
